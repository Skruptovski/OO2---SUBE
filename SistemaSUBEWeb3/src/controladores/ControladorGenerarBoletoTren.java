...
public class ControladorGenerarBoletoTren extends HttpServlet {
	...
	private void procesarPeticion(HttpServletRequest request , HttpServletResponse response ) throws ServletException, IOException {
		...
		try {
			...
			LectorTrenABM lectorAbm = LectorTrenABM.getInstanciaLectorTrenABM();
			...
			LectorTren lector = lectorAbm.traer(estacion);
			...
			request.getRequestDispatcher("boletoT.jsp").forward(request, response);
			}
			catch (Exception e) {
